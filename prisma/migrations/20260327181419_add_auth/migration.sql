/*
  ...
  - Added the required column `userId` to the `Supplement` table without a default value. This is not possible if the table is not empty.

*/
-- Clear existing rows that have no valid userId
DELETE FROM "DeductionLog";
DELETE FROM "SkippedIntake";
DELETE FROM "SupplementPerson";
DELETE FROM "Person";
...
-- AlterTable
ALTER TABLE "Supplement" ADD COLUMN     "userId" TEXT NOT NULL;
